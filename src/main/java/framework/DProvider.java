...
public class DProvider {
    ...
    public Object[][] getData() throws FileNotFoundException {
        JsonElement jsonData = new JsonParser().parse(new FileReader("src/main/resources/getUserByIdTestData.json"));
    ...
    public Object[][] getPostData() throws FileNotFoundException {
        JsonElement jsonData = new JsonParser().parse(new FileReader("src/main/resources/getPostByIdTestData.json"));
        JsonElement dataSet = jsonData.getAsJsonObject().get("dataSet");
